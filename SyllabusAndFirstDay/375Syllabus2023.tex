...
\begin{center}
{\bf Physics 375: Thermal \& Statistical Physics; M$\Theta$
  1:00PM-2:20PM; CST 225
}
\end{center}
...
\vskip.15in
\noindent\textbf{Office Hours:} See Moodle
%encouraged to stop in to ask questions whenever my door is open. That's
%most of the time.

\vskip.15in 
\noindent\textbf{When and where:} Mondays and Thursdays, 1:00-2:20
PM, CST 225

\vskip.15in 
\noindent\textbf{Credits:} This is a three-credit course. This is fulfilled via three hours of in-person instruction per week over a 15-week semester. 

\vskip.15in 
\noindent\textbf{COVID:} Campus-wide coronavirus policies and information: \url{https://earlham.edu/coronavirus}

Hey read this blog post on the atmosphere:
\url{https://gravityandlevity.wordpress.com/2018/07/14/how-thick-is-the-atmosphere-a-derivation-of-the-boltmzann-distribution/}

Hey read this blog post on jarzynski \url{https://www.wondriumdaily.com/itn-second-law-thermodynamics/}
...
\textbf{Attendance/preparation/participation (including Discord)} &      & 3    & 15     \\
\textbf{Weekly homework }                                        & 13      & 1    & 30     \\
\textbf{Lab }                                        & 1      & 0    & 7     \\
\textbf{Midterms }                                    & 2      & 0    & 18 (9\% each)     \\
\textbf{Independent project }                                    & 1      & 0    & 15     \\
\textbf{Final exam }                                              & 1      & 0    & 15     \\ \hline
\end{tabular}
\end{table}
}
...
\Holiday{3/11/2023}{\textit {Spring Break}}
\Holiday{3/12/2023}{\textit {Spring Break}}
\Holiday{3/13/2023}{\textit {Spring Break}}
\Holiday{3/14/2023}{\textit {Spring Break}}
\Holiday{3/15/2023}{\textit {Spring Break}}
\Holiday{3/16/2023}{\textit {Spring Break}}
\Holiday{3/17/2023}{\textit {Spring Break}}
\Holiday{3/18/2023}{\textit {Spring Break}}
\Holiday{3/19/2023}{\textit {Spring Break}}

\Holiday{4/19/2017}{\textit{Campuswide EPIC Expo}}

\Holiday{5/8/2023}{1:30 Finals: comprehensive but with emphasis on
  later topics} 
\Holiday{5/9/2023}{Reading Day} 
\Holiday{5/10/2023}{Finals (other classes)} 
\Holiday{5/11/2023}{Finals (other classes)} 
\Holiday{5/12/2023}{College housing closes} 
% ... and so on
